...
export function LandingHero() {
  return (
    <>
      ...
      <div aria-label="Marcas asociadas" className="grid grid-cols-3 bg-blue-50 px-6 py-6 text-center text-xs font-bold uppercase tracking-[0.2em] text-navy/30 sm:grid-cols-6">{Array.from({ length: 6 }, (_, index) => <span key={index}>marca</span>)}</div>
