  ...
  return (
    <div className="mt-7 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
      {representatives.map((rep) => {
        ...
        return <article key={rep.id} className={`group/representative relative flex flex-col rounded-2xl border bg-white p-4 shadow-sm transition ${selected ? "border-blue ring-2 ring-blue/30" : "border-navy/10 hover:border-blue-mid"}`}>
