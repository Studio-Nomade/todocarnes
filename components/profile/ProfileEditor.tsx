...
export function ProfileEditor({ initialProfile }: { initialProfile: ProfileInput }) {
  ...
  return (
    <form className="rounded-2xl border border-ink/10 bg-white p-6 shadow-sm sm:p-8" onSubmit={submit}>
      <div className="flex items-center gap-5 border-b border-ink/10 pb-7">
      ...
      <section className="mt-9">
        ...
        <div className="mt-4 overflow-x-auto rounded-xl border border-ink/10 bg-gray-50 p-4">
          <EmailSignature {...profile} />
        </div>
      </section>

      <div className="mt-8 flex items-center justify-end gap-4 border-t border-ink/10 pt-6">
