...
const logoUrl = "../assets/header-correos.jpg";
const contact = {
  area: "Food Service",
  company: "Ejemplo SpA",
...
const previews = [
  ...
  ["02-courtesy-confirmation.html", <CourtesyConfirmation cargo="Jefa de compras" company={contact.company} eventLocation={event.eventLocation} eventName={event.eventName} lastName="Rojas" logoUrl={logoUrl} name={contact.name} rut="12.345.678-5" />],
